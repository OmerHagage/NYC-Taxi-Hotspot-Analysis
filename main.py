...
def combine_csv(year, month_range):
    ...
    # df = df.sample(frac=.14, replace=False)
...
if __name__ == '__main__':
    ...
    # # If the csvs already combined.
    # _, zone_dict = load_location_data()
    ...
    centroids_rides_percentage, test_rides_percentage = \
        evaluate_clustering(test_df, centroids, bbox)
